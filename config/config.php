...
/* 基本设置。Basic settings. */
$config->version    = '4.9';                // ZenTaoPHP的版本。 The version of ZenTaoPHP. Don't change it.
$config->charset    = 'UTF-8';              // ZenTaoPHP的编码。 The encoding of ZenTaoPHP.
$config->cookieLife = time() + 2592000;     // Cookie的生存时间。The cookie life time.
$config->timezone   = 'Asia/Shanghai';      // 时区设置。        The time zone setting, for more see http://www.php.net/manual/en/timezones.php.
$config->webRoot    = getWebRoot();         // URL根目录。       The root path of the url.
$config->notEncryptedPwd = true;            // 密码不加密
$config->administrator   = 'admin';
$config->adminpassword   = '123456';

/* 框架路由相关设置。Routing settings. */
$config->requestType = 'GET';               // 请求类型：PATH_INFO|PATHINFO2|GET。    The request type: PATH_INFO|PATH_INFO2|GET.
...
$config->default->lang   = 'cn';          //默认语言。 Default language.
