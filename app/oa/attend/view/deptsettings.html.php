  ...
  <div class='side'>
    <nav class='menu leftmenu affix'>
      <ul class='nav nav-primary'>
        ...
        <li><?php commonModel::printLink('attend', 'deptsettings', '', $lang->attend->deptSettings);?></li>
...
<?php endif;?>
    <div class='panel'>
      <div class='panel-heading'><?php echo $lang->attend->deptSettings;?></div>
      <div class='panel-body'>
        <form id='ajaxForm' method='post'>
          <table class='table table-form table-condensed w-p70'>
            <tr>
              <th class='w-150px'><?php echo $lang->attend->setDept;?></th>
              <td class='w-300px'><?php echo html::select('dept', $depts, $dept)?></td>
