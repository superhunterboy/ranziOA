...
$lang->refund->common       = '申请';
$lang->refund->create       = '添加申请';
$lang->refund->browse       = '申请列表';
$lang->refund->personal     = '我的申请';
$lang->refund->company      = '所有申请';
$lang->refund->todo         = '待申请';
$lang->refund->browseReview = '申请审批列表';
$lang->refund->edit         = '编辑申请';
$lang->refund->view         = '详情';
$lang->refund->delete       = '删除';
$lang->refund->review       = '审批';
$lang->refund->detail       = '明细';
$lang->refund->reimburse    = '申请存档';
$lang->refund->cancel       = '撤销';
$lang->refund->commit       = '提交';
$lang->refund->settings     = '设置';
$lang->refund->setReviewer  = '审批人设置';
$lang->refund->setCategory  = '申请类型设置';
$lang->refund->setDepositor = '报销账户设置';
$lang->refund->setRefundBy  = '报销者设置';
$lang->refund->export       = '导出申请记录';
...
$lang->refund->categoryTips      = '尚未设置支出类型。';
$lang->refund->setExpense        = '设置类型';
...
$lang->refund->settings->setCategory  = "报销类型|refund|setcategory";
