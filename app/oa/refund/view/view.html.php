  ...
  <div class='col-main'>
    <div class='panel'>
      ...
      <div class='panel-body'>
        <p><?php echo sprintf($lang->refund->descTip, zget($users, $refund->createdBy))?></p>
      ...
      <div class='panel-body no-padding'>
        <table class='table table-fixed table-hover text-center'>
          <tr class="text-center">
            ...
            <th class='w-100px hide'><?php echo $lang->refund->money;?></th>
          ...
          <tr>
            <td><?php echo $d->id;?></td>
            <td class='hide'><?php echo zget($currencySign, $d->currency) . $d->money;?></td>
