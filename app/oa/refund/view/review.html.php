...
<form method='post' id='ajaxForm' action='<?php echo inlink('review', "refundID={$refund->id}")?>'>
  <div class='refundTable'>
    <table class='table table-fixed table-bordered'>
      ...
      <tr class='text-center'>
        ...
        <th class='w-120px'><?php echo $lang->refund->dept;?></th>
        <th class='w-80px hide'><?php echo $lang->refund->money;?></th>
      ...
      <tr class='text-center'>
        ...
        <td class='text-right hide'><?php echo zget($currencySign, $detail->currency) . "<span class='detailMoney'>" . $detail->money . "</span>";?></td>
      ...
      <tr class='text-center'>
        ...
        <td><?php echo zget($deptList, $refund->dept);?></td>
        <td class='text-right hide'><?php echo zget($currencySign, $refund->currency) . "<span class='detailMoney'>" . $refund->money . "</span>";?></td>
  ...
  <table class='table table-borderless'>
    <tr class='reviewMoney'>
      <th class='w-70px text-center text-middle hide'><?php echo $lang->refund->reviewMoney;?></th>
      <td class='w-300px hide'>
