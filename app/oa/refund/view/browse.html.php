      ...
      <table class='table table-hover table-striped tablesorter table-data table-fixed text-center' id='refundTable'>
        <thead>
          <tr class='text-center'>
            ...
            <th class='w-120px text-center visible-lg'><?php commonModel::printOrderLink('dept', $orderBy, $vars, $lang->refund->dept);?></th>
            ...
            <th class='w-100px text-right hide'><?php commonModel::printOrderLink('money', $orderBy, $vars, $lang->refund->money);?></th>
            ...
            <th class='w-80px hide'><?php commonModel::printOrderLink('refundBy', $orderBy, $vars, $lang->refund->refundBy);?></th>
            <th class='w-80px hide'><?php commonModel::printOrderLink('refundDate', $orderBy, $vars, $lang->refund->refundDate);?></th>
        ...
        <tr id='refund<?php echo $refund->id;?>' data-url='<?php echo $this->createLink('refund', 'view', "refundID={$refund->id}&mode={$mode}");?>'>
          ...
          <td class='text-center visible-lg'><?php echo zget($deptList, $refund->dept);?></td>
          ...
          <td class='text-center hide'><?php echo zget($currencySign, $refund->currency) . $refund->money;?></td>
          ...
          <td class='hide'><?php echo zget($userPairs, $refund->refundBy);?></td>
          <td class='hide'><?php echo formatTime($refund->refundDate, DT_DATE1)?></td>
