...
$lang->attend->menu->approve    = 'Approved|attend|approved|';
$lang->attend->menu->leave      = 'Leave|attend|leave|';
$lang->attend->menu->lieu       = 'Lieu|attend|lieu|';
$lang->attend->menu->overtime   = 'Overtime|attend|overtime|';
$lang->attend->menu->makeup     = 'makeup|attend|makeup|';
$lang->attend->menu->trip       = 'Trip|attend|trip|';
