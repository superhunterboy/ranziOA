...
$lang->menu->oa->refund    = '申请|refund|personal|';
...
$lang->attend->menu->raw        = '考勤机|attend|raw|';
...
$lang->attend->menu->approve    = '补录|attend|approved|';
$lang->attend->menu->leave      = '请假|attend|leave|';
$lang->attend->menu->lieu       = '调休|attend|lieu|';
$lang->attend->menu->overtime   = '加班|attend|overtime|';
$lang->attend->menu->makeup     = '补班|attend|makeup|';
$lang->attend->menu->trip       = '出差|attend|trip|';
...
$lang->refund->menu->personal = array('link' => '我的申请|refund|personal|', 'alias' => 'create,edit');
...
$lang->refund->menu->company    = '所有申请|refund|company|';
