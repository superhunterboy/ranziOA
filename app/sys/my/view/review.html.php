...
<div class='panel'>
  <table class='table table-hover table-striped table-sorter table-data table-fixed text-center <?php echo $appendClass?>'>
    ...
    <tr>
      ...
      <?php endif;?>
        <td><?php echo zget($deptList, $usersdept[$attend->account])?></td>
      <td><?php echo $attend->account;?></td>
  ...
  <table class='table table-data table-hover text-center table-fixed tablesorter <?php echo $appendClass?>' id='leaveTable'>
    <thead>
      <tr class='text-center'>
        ...
        <th class='w-150px'><?php commonModel::printOrderLink('status', $orderBy, $vars, $lang->leave->status);?></th>
        <th class='w-100px'><?php echo $lang->actions;?></th>
      </tr>
    </thead>
    ...
    <tr>
      ...
      <td title='<?php echo $leave->desc?>'><?php echo zget($lang->leave->countryList, $leave->country).' '.$leave->desc;?></td>
      ...
      <td>
        ...
        <?php if($type != 'all'&&  $leave->createdBy != $this->app->user->account) {?>
  ...
  <table class='table table-hover table-striped table-sorter table-data table-fixed text-center <?php echo $appendClass?>'>
    <thead>
      <tr class='text-center'>
        ...
        <th class='w-120px text-right hide'><?php echo $lang->refund->money;?></th>
    ...
    <tr>
      ...
      <td class='text-center' title='<?php echo $refund->name;?>'><?php echo $refund->name;?></td>
      <td class='text-center' title='<?php echo zget($categories, $refund->category, '');?>'><?php echo zget($categories, $refund->category, '');?></td>
      <td class='text-right hide'><?php echo zget($currencySign, $refund->currency) . $refund->money;?></td>
  ...
  <table class='table table-data table-hover text-center table-fixed tablesorter <?php echo $appendClass?>' id='leaveTable'>
    <thead>
      <tr class='text-center'>
        ...
        <th><?php echo $lang->leave->country;?></th>
        <th><?php echo $lang->leave->desc;?></th>
    ...
    <tr>
      ...
      <td><?php echo zget($lang->leave->countryList, $leave->country);?></td>
      ...
      <td>
        <?php $mode = $leave->status == 'pass' ? 'back' : '';?>
        <?php if($type != 'all') {?><?php commonModel::printLink('oa.leave', 'review', "id={$leave->id}&status=pass&mode=$mode",   $lang->leave->statusList['pass'],   "data-status='pass' data-toggle='ajax'");?>
        <?php commonModel::printLink('oa.leave', 'review', "id={$leave->id}&status=reject&mode=$mode", $lang->leave->statusList['reject'], "data-toggle='modal'");?>
      <?php }?></td>
    </tr>
    <?php endforeach;?>
    ...
    <tr>
      ...
      <td>
        <?php if($type != 'all') {?><?php commonModel::printLink('oa.makeup', 'review', "id={$makeup->id}&status=pass",   $lang->makeup->statusList['pass'],   "data-status='pass' data-toggle='ajax'");?>
        <?php commonModel::printLink('oa.makeup', 'review', "id={$makeup->id}&status=reject", $lang->makeup->statusList['reject'], "data-toggle='modal'");?>
      <?php }?></td>
    </tr>
    <?php endforeach;?>
    ...
    <tr>
      ...
      <td>
        <?php if($type != 'all') {?><?php commonModel::printLink('oa.overtime', 'review', "id={$overtime->id}&status=pass",   $lang->overtime->statusList['pass'],   "data-status='pass' data-toggle='ajax'");?>
        <?php commonModel::printLink('oa.overtime', 'review', "id={$overtime->id}&status=reject", $lang->overtime->statusList['reject'], "data-toggle='modal'");?>
      <?php }?></td>
    </tr>
    <?php endforeach;?>
    ...
    <tr>
      ...
      <td>
        <?php if($type != 'all') {?><?php commonModel::printLink('oa.lieu', 'review', "id={$lieu->id}&status=pass",   $lang->lieu->statusList['pass'],   "data-status='pass' data-toggle='ajax'");?>
        <?php commonModel::printLink('oa.lieu', 'review', "id={$lieu->id}&status=reject", $lang->lieu->statusList['reject'], "data-toggle='modal'");?>
      <?php }?></td>
    </tr>
    <?php endforeach;?>
