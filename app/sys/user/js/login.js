...
$('#submit').click(function()
{
    ...
    $.ajax(
    {
        ...
        type: "POST",
        data:"account=" + $('#account').val() + '&password=' + encodeURIComponent(password) + '&referer=' + encodeURIComponent($('#referer').val()) + '&rawPassword=' + rawPassword + '&keepLogin=' + $('#keepLoginon').is(':checked'),
