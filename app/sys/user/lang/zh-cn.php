...
$lang->user->qq        = 'QQ';
$lang->user->yahoo     = '雅虎通';
$lang->user->gtalk     = 'Telegram';
$lang->user->wangwang  = '旺旺';
$lang->user->mobile    = '手机';
$lang->user->phone     = '电话';
$lang->user->dept      = '部门';
$lang->user->address   = '通讯地址';
$lang->user->zipcode   = 'Messenger';
$lang->user->join      = '加入日期';
...
$lang->user->submit          = "提交";
$lang->user->forbid          = '离职';
$lang->user->forbidList      = '离职成员列表';
$lang->user->normalList      = '在职成员列表';
$lang->user->active          = '激活';
