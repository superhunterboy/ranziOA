...
js::set('notEncryptedPwd', empty($config->notEncryptedPwd) ? true : $config->notEncryptedPwd);
      ...
      <form method='post' target='hiddenwin' class='form-condensed'>
        ...
        <div class='row'>
            <div class='col-xs-4 text-center'>
                <?php echo html::image($this->config->webRoot . 'theme/default/images/logo.png'); ?>
            </div>
          <div class='col-xs-8'>
            <table class='table table-form'>
              ...
              <tr>
                ...
                <tr><th></th><td><?php echo html::checkbox('keepLogin', array('on' => $lang->user->keepLogin), $this->cookie->keepLogin ? $this->cookie->keepLogin : 'off');?></td></tr>
            </table>
          </div>
        </div>
      </form>
