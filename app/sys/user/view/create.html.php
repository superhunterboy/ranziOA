      ...
      <div class='panel-body'>
        <form method='post' id='ajaxForm'>
          <table class='table table-form'>
            ...
            <tr>
              <th class='w-100px'><?php echo $lang->user->supervisor;?></th>
              <td class='w-p40'><?php echo html::input('supervisor', '', "class='form-control' autocomplete='off'");?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><?php echo html::select('role', $lang->user->roleList, '', "class='form-control'");?></td>
              <td></td>
            </tr>
            <tr>
