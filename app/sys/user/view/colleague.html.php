  ...
  <div class='clearfix'>
    <div class="panel">
      ...
      <div class='cards cards-user'>
        ...
        <?php if($user->account == 'admin') continue;?>
        <div class='col-card'>
          <div class='card card-user gender-<?php echo $user->gender?>'>
            ...
            <div class='card-content'>
              <dl class='contact-info'>
                ...
                <?php if($user->phone) echo "<dd><i class='icon icon-phone-sign'></i> $user->phone</dd>";?>
                <?php if($user->mobile) echo "<dd><i class='icon icon-globe'></i> $user->mobile</dd>";?>
                ...
                <?php if($user->gtalk) echo "<dd><i class='icon icon-comments'></i> $user->gtalk </dd>";?>
              </dl>
            </div>
