        ...
        <div class="panel">
          <div class="panel-heading">
            ...
            <div class="pull-right panel-actions">
              <?php echo html::a(inlink('admin'), $lang->user->normalList, "class='btn btn-primary pull-left' style='margin-right: 10px;'");?>
          ...
          <table class='table table-hover table-striped table-bordered tablesorter table-fixed'>
            <thead>
              <tr class='text-center'>
                ...
                <th><?php commonModel::printOrderLink('supervisor', $orderBy, $vars, $lang->user->supervisor);?></th>
                <th class='w-100px'><?php commonModel::printOrderLink('realname', $orderBy, $vars, $lang->user->realname);?></th><th class='w-60px'><?php commonModel::printOrderLink('gender', $orderBy, $vars, $lang->user->gender);?></th>
