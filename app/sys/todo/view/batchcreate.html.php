...
<form class='form-condensed' id='ajaxForm' method='post' action='<?php echo $this->createLink('todo', 'batchcreate')?>'>
  <div id='titlebar'>
    <div class='input-group w-200px'>
      ...
      <div class="input-group w-200px" >
          <span class="input-group-addon"><?php echo $lang->todo->assignedTo;?></span>
          <?php echo html::select("assignedTo", $users, 0, "class='w-100px form-control chosen'");?>
      </div>
  </div>
  <div class='panel'>
    <table class='table table-form table-fixed'>
      <thead>
        <tr class='text-center'>
          ...
          <th class='w-80px'><?php echo $lang->todo->finishedDate;?></th>
      ...
      <tr class='text-center'>
        ...
        <td><?php echo html::textarea("descs[$i]", '', "rows='1' class='form-control' autocomplete='off'");?></td>
        <td colspan='2'>
          <div class='input-group'>
            <?php echo html::select("ends[$i]", $times, '', "onchange=\"setBeginsAndEnds($i, 'end');\" class='form-control'");?>
