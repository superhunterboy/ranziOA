...
$lang->todo->menu->batchcreate     = '批量添加|todo|batchcreate|';
...
$lang->my->review->menu->refund   = '申请|my|review|type=refund';
$lang->my->review->menu->approved   = '已审批|my|review|type=approved';
